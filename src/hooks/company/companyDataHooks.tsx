...
//interface
import { ICompanyAllFormsDataReponse, ICompanyDataQueryType, ICompanyDetailsResponse, IFormSectionGetAllResponse, IFormsGetAllResponse, IGETAllDepartamentsResponse, IGETAllDutiesResponse, IGETAllShiftsResponse, IGETCompanyAllFilesResponse, IGETCompanyDataQuery, IGETCompanyResponse, IGETCompanyRosterResponse, IGETHistoryResponse, IGETRolesResponse, IGETRosterTaskResponse, IGETSmsResponse, IGetAllNotificationResponse, IGetAllTransactionsResponse, IHaccpReportsResponse, IRequestsGetAllResponse, IRosterPageResponse, IRosterPaymentPageResponse } from "./IGetCompanyDataHooks.interface";
...
export function useGETCompanyDataHooks({
    ...
    return {
        ...
        serviceSMSApi: data as IGETSmsResponse,
