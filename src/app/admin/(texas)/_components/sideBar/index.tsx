...
export function Sidebar() {
    ...
    return (
        <>
            <div className={cn('fixed top-0 h-screen w-full z-40 bg-[rgba(0,0,0,0.15)] duration-75', isOpen ? "left-0" : 'left-[-100%]')} onClick={toggleSideBar} />
            <nav className={cn('fixed flex-col-container top-0 z-50 h-screen w-[80%] max-w-[250px] gap-10 py-8 px-4 transition-[left] bg-background duration-200 ', isOpen ? "left-0" : 'left-[-100%]')}>
