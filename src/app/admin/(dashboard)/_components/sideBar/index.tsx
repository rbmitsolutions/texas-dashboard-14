...
export function Sidebar() {
    ...
    return (
        <>
            <div className={cn('fixed top-0 h-screen w-full z-40 bg-[rgba(0,0,0,0.15)] duration-300 xl:hidden', isOpen ? "left-0" : 'left-[-100%]')} onClick={toggleSideBar} />
            <nav className={cn('fixed flex-col-container top-0 z-50 h-screen w-[80%] gap-10 py-8 px-4 transition-[left] bg-background duration-500 border-r-2 xl:sticky xl:flex-col-container xl:w-full xl:gap-10', isOpen ? "left-0" : 'left-[-100%]')}>
