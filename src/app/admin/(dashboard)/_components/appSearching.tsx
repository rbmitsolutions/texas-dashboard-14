    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="flex-col-container min-h-80 h-80 max-h-80 bg-background-soft p-4 rounded-lg overflow-auto scrollbar-thin">
                    {data?.filter(s =>
                        s.key_words?.some(k => k?.includes(search?.toLowerCase()))
